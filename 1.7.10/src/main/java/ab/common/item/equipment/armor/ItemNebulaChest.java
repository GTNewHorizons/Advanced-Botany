...
public class ItemNebulaChest extends ItemNebulaArmor {
	...
	public Multimap getAttributeModifiers(ItemStack stack) {
	    ...
	    hashMultimap.put(SharedMonsterAttributes.knockbackResistance.getAttributeUnlocalizedName(), new AttributeModifier(uuid, "NebulaChest modifier", 1.0D * (1.0f - (this.getDamage(stack) / 1000.0f)), 0));
