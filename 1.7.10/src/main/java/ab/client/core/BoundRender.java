...
public class BoundRender {
	...
	public void onWorldRenderLast(RenderWorldLastEvent event) {
	    ...
	    if(stack != null && stack.getItem() instanceof ICoordBoundItem) {
	        ...
	        if(pos != null) {
	        	...
	        	if(tile != null && tile instanceof IBoundRender)
	...
	private void renderBlockOutlineAt(ChunkCoordinates pos, int color, float thickness) {
		GL11.glPushMatrix();
	    GL11.glTranslated(pos.posX - RenderManager.renderPosX, pos.posY - RenderManager.renderPosY, pos.posZ - RenderManager.renderPosZ + 1.0D);
	    ...
	    if(block != null) {
	    	...
	    	if(block instanceof IWireframeAABBProvider) {
	    		axis = ((IWireframeAABBProvider)block).getWireframeAABB((World)worldClient, pos.posX, pos.posY, pos.posZ);
	    	} else {
