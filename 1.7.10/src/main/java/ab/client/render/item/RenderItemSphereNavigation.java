...
public class RenderItemSphereNavigation implements IItemRenderer {
	...
	public void renderItem(IItemRenderer.ItemRenderType type, ItemStack stack, Object... data) {
		...
		ItemRenderer.renderItemIn2D(Tessellator.instance, iconEnable.getMaxU(), iconEnable.getMinV(), iconEnable.getMinU(), iconEnable.getMaxV(), iconEnable.getIconWidth(), iconEnable.getIconHeight(), 0.0625F);	   
		...
		ItemRenderer.renderItemIn2D(Tessellator.instance, iconBlock.getMaxU(), iconBlock.getMinV(), iconBlock.getMinU(), iconBlock.getMaxV(), iconBlock.getIconWidth(), iconBlock.getIconHeight(), 0.0625F);	   
