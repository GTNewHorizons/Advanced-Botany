...
public class RenderAntigravityCharm implements IItemRenderer {
	...
	public void renderItem(IItemRenderer.ItemRenderType type, ItemStack item, Object... data) {
	    ...
	    ItemRenderer.renderItemIn2D(Tessellator.instance, iconIsland.getMaxU(), iconIsland.getMinV(), iconIsland.getMinU(), iconIsland.getMaxV(), iconIsland.getIconWidth(), iconIsland.getIconHeight(), 0.0625F);	    
