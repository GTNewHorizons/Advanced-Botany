...
public class FXWisp extends EntityFX {
    ...
    public FXWisp(final World world, final double d, final double d1, final double d2, final float f, final float f1,
            final float f2) {
        this(world, d, d1, d2, 1.0f, f, f1, f2);
    }

    public FXWisp(final World world, final double d, final double d1, final double d2, final float f, float red,
    ...
    public FXWisp(final World world, final double d, final double d1, final double d2, final double x, final double y,
            final double z, final float f, final int type) {
    ...
    public FXWisp(final World world, final double d, final double d1, final double d2, final Entity tar,
            final int type) {
    ...
    public FXWisp(final World world, final double d, final double d1, final double d2, final double x, final double y,
            final double z, final float f, final float red, final float green, final float blue) {
    ...
    public void onUpdate() {
        ...
        if (this.particleAge == 0 && this.tinkle && this.worldObj.rand.nextInt(3) == 0) {
            this.worldObj.playSoundAtEntity(
                    ...
                    "random.orb",
                    0.02f,
                    0.5f * ((this.worldObj.rand.nextFloat() - this.worldObj.rand.nextFloat()) * 0.6f + 2.0f));
        }
