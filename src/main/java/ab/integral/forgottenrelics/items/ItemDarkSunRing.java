...
public class ItemDarkSunRing extends ItemBaubleBase implements IBauble {
    ...
    public void addInformation(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, List par3List, boolean par4) {
        if (GuiScreen.isShiftKeyDown()) {
            ...
            par3List.add(
                    StatCollector.translateToLocal("item.ItemDarkSunRing2_1.lore") + " "
                            + (int) RelicsConfigHandler.darkSunRingDamageCap
                            + StatCollector.translateToLocal("item.ItemDarkSunRing2_2.lore"));
            ...
            par3List.add(
                    StatCollector.translateToLocal("item.ItemDarkSunRing4_1.lore") + " "
                            + (int) (RelicsConfigHandler.darkSunRingDeflectChance * 100F)
                            + StatCollector.translateToLocal("item.ItemDarkSunRing4_2.lore"));
