...
public class ItemAdvancedMiningCharm extends ItemBaubleBase {
    ...
    public void addInformation(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, List par3List, boolean par4) {
        if (GuiScreen.isShiftKeyDown()) {
            par3List.add(
                    StatCollector.translateToLocal("item.ItemAdvancedMiningCharm1_1.lore") + " "
                            + (int) (RelicsConfigHandler.advancedMiningCharmBoost * 100F)
                            + StatCollector.translateToLocal("item.ItemAdvancedMiningCharm1_2.lore"));
            par3List.add(
                    StatCollector.translateToLocal("item.ItemAdvancedMiningCharm2_1.lore") + " "
                            + RelicsConfigHandler.advancedMiningCharmReach
                            + StatCollector.translateToLocal("item.ItemAdvancedMiningCharm2_2.lore"));
