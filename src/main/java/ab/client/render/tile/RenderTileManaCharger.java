...
public class RenderTileManaCharger extends TileEntitySpecialRenderer {
	...
	public void renderTileEntityAt(final TileEntity tile, final double x, final double y, final double z, final float ticks) {
	...
	public void renderItemStack(ItemStack stack) {
		if (stack != null) {
			...
			if (!ForgeHooksClient.renderEntityItem(new EntityItem(this.charger.getWorldObj(), this.charger.xCoord, this.charger.yCoord, this.charger.zCoord, stack), stack, 0.0F, 0.0F, (this.charger.getWorldObj()).rand, mc.renderEngine, RenderBlocks.getInstance(), 1)) {
