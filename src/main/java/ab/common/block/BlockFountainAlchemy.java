...
public class BlockFountainAlchemy extends BlockContainer implements ILexiconable {

    public BlockFountainAlchemy() {
        super(Material.iron);
        this.setCreativeTab(AdvancedBotany.tabAB);
        this.setHardness(3.0F);
        this.setResistance(10.0F);
        this.setStepSound(soundTypeMetal);
        this.setBlockName("ABAlchemy");
    }
    ...
    public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int par6, float par7,
        ...
        TileFountainAlchemy tile = (TileFountainAlchemy) world.getTileEntity(x, y, z);
