...
public class TileFountainConjuration extends TileInventory implements ISparkAttachable, ISidedInventory {

    private int mana;
    public int manaToGet;
    private RecipeFountainConjuration currentRecipe;
    ...
    public void readCustomNBT(NBTTagCompound cmp) {
        ...
        else this.currentRecipe = AdvancedBotanyAPI.FountainConjurationRecipes.get(recipeID);
    }
    ...
    public String getInventoryName() {
        return "tileFountainConjuration";
    }
