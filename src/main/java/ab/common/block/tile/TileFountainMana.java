...
public class TileFountainMana extends TileInventory implements ISparkAttachable, ISidedInventory {

    private int mana;
    public int manaToGet;
    private RecipeFountainMana currentRecipe;
    ...
    public void readCustomNBT(NBTTagCompound cmp) {
        ...
        else this.currentRecipe = AdvancedBotanyAPI.FountainManaRecipes.get(recipeID);
    }
