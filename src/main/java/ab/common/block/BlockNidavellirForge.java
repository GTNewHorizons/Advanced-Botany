...
public class BlockNidavellirForge extends BlockContainer implements ILexiconable {
	...
	public void setBlockBoundsBasedOnState(IBlockAccess world, int x, int y, int z) {
		...
		switch(world.getBlockMetadata(x, y, z)) {
			case 0: this.setBlockBounds(f, 0.0F, f1, 1.0F - f, 0.75F, 1.0F);
				break;
			case 1: this.setBlockBounds(0.0F, 0.0F, f, 1.0F - f1, 0.75F, 1.0F - f);
				break;
			case 2: this.setBlockBounds(f, 0.0F, 0.0F, 1.0F - f, 0.75F, 1.0F - f1);
				break;
			case 3: this.setBlockBounds(f1, 0.0F, f, 1.0F, 0.75F, 1.0F - f);
				break;
