...
public class BlockFountainConjuration extends BlockContainer implements ILexiconable {

    public BlockFountainConjuration() {
        super(Material.iron);
        this.setCreativeTab(AdvancedBotany.tabAB);
        this.setHardness(3.0F);
        this.setResistance(10.0F);
        this.setStepSound(soundTypeMetal);
        this.setBlockName("ABConjuration");
    }
    ...
    public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int par6, float par7,
        ...
        TileFountainConjuration tile = (TileFountainConjuration) world.getTileEntity(x, y, z);
