...
public abstract class ItemBauble extends Item implements IBauble, ICosmeticAttachable, IPhantomInkable {
	...
	public ItemStack onItemRightClick(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer) {
		...
		if(canEquip(par1ItemStack, (EntityLivingBase)par3EntityPlayer)) {
			...
			for(int i = 0; i < baubles.getSizeInventory(); i++) {
				if(baubles.isItemValidForSlot(i, par1ItemStack)) {
					...
					if(stackInSlot == null || ((IBauble)stackInSlot.getItem()).canUnequip(stackInSlot, (EntityLivingBase)par3EntityPlayer)) {
						...
						if(stackInSlot != null) {
							((IBauble)stackInSlot.getItem()).onUnequipped(stackInSlot, (EntityLivingBase)par3EntityPlayer);
	  ...
	  public void addHiddenTooltip(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, List<String> par3List, boolean par4) {
		  ...
		  if(cosmetic != null)
			  addStringToTooltip(String.format(StatCollector.translateToLocal("botaniamisc.hasCosmetic"), new Object[] { cosmetic.getDisplayName() }), par3List); 
