...
public class RecipeListAB implements IModHelper {
    ...
    public static RecipeAdvancedPlate ConversionRecipe;
    ...
    public static void setupCrafting() {
        ...
        LebWoodRecipe = AdvancedBotanyAPI.registerAdvancedPlateRecipe(
                ...
                30000,
                0x29de20);
        ConversionRecipe = AdvancedBotanyAPI.registerAdvancedPlateRecipe(
                new ItemStack(ItemListAB.itemABResource, 3, 1),
                new ItemStack(ModItems.manaResource, 1, 19),
        ...
        ConversionRecipe = AdvancedBotanyAPI.registerAdvancedPlateRecipe(
                ...
                OreDictionary.getOres("ingotPlatinum").get(0),
