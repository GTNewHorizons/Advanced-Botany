...
public class AdvancedPlateMT {
	...
	@ZenMethod
	public static void addRecipe(IItemStack output, String rgb, IItemStack input1, IItemStack input2, IItemStack input3, int mana) {
		MineTweakerAPI.apply(new Add(new RecipeAdvancedPlate(MineTweakerMC.getItemStack(output), mana, Integer.decode(rgb), MineTweakerMC.getItemStack(input1), MineTweakerMC.getItemStack(input2), MineTweakerMC.getItemStack(input3))));
	}
