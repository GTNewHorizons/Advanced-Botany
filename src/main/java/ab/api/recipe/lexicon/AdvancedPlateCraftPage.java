...
public class AdvancedPlateCraftPage extends PageRecipe {
	...
	public void renderRecipe(IGuiLexiconEntry gui, int mx, int my) {
	    ...
	    float currentDegree = ConfigHandler.lexiconRotatingItems ? (GuiScreen.isShiftKeyDown() ? this.ticksElapsed : (this.ticksElapsed + ClientTickHandler.partialTicks)) : 0.0F;
	  ...
	  public void renderManaBar(IGuiLexiconEntry gui, int mx, int my) {
	    ...
	    font.drawString(manaUsage, gui.getLeft() + gui.getWidth() / 2 - font.getStringWidth(manaUsage) / 2, gui.getTop() + 105, 1711276032);
