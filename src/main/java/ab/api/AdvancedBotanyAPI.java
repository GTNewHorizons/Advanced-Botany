...
public class AdvancedBotanyAPI {
	...
	public static Item.ToolMaterial mithrilToolMaterial = EnumHelper.addToolMaterial("MITHRIL", 7, -1, 8.0F, 8.0F, 20);
	
	public static RecipeAdvancedPlate registerAdvancedPlateRecipe(ItemStack output, ItemStack input1, ItemStack input2, ItemStack input3, int mana) {
		RecipeAdvancedPlate recipe = new RecipeAdvancedPlate(output, mana, input1, input2, input3);
