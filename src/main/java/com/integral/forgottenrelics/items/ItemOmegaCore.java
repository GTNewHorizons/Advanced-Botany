            ...
            if (wandList.size() > 0) {
                ...
                for (int counter = 0; counter < primalAspects.size(); counter++) {
                    ...
                    ItemStack randomWand = SuperpositionHandler
                            .getRandomValidWand(wandList, primalAspects.get(counter));

                    if (randomWand != null) ((ItemWandCasting) randomWand.getItem())
                            .addVis(randomWand, primalAspects.get(counter), 1, true);
